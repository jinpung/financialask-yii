...
/**
 * This is the model class for table "AdminNotificationStatus".
 *
 * The followings are the available columns in table 'AdminNotificationStatus':
 * @property integer $id
 * @property integer $notificationId
 * @property integer $userId
 */
class AdminNotificationStatus extends CActiveRecord
{
	/**
	 ...
	 * @return AdminNotificationStatus the static model class
	 */
