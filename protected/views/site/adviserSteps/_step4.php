...
<div class="register-form">
    ...
    <?php echo $form->hiddenField($model, 'postcode') ?>
    <?php echo $form->hiddenField($model, 'yearStartPractice') ?>
    <?php
    echo $form->dropDownList($model, 'specialtiesList', array_merge(array(), Specialties::getList()), array(
        'class' => 'hidden',
        'multiple' => 'multiple',
    ));
    ?>

    <?php /* echo $form->hiddenField($model, 'specialtiesList') */ ?>
    <?php echo $form->hiddenField($model, 'bio') ?>
